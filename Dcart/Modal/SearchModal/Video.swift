...
struct VideoList {
   ...
   static let topTen = [
       Video(imageName: "wish-i-knew",
             title: "What Is Xcode and How to Use It?",
             description: "There are countless benefits of using Xcode as a productive IDE for the software development of Apple devices. Also, Xcode is required for code signing and submitting to store-created applications.",
             viewCount: 370222,
             uploadDate: "February 17, 2019",
             url: URL(string: "https://youtu.be/EgpKu1tAVMY")!,
             imageURL: URL(string: "https://www.netguru.com/hs-fs/hubfs/Xcode_IDE_general_point_of_view.jpg?width=598&name=Xcode_IDE_general_point_of_view.jpg")!),
       ...
       imageURL: URL(string: "https://browserstack.wpenginepowered.com/wp-content/uploads/2023/04/Xcode-running-on-macOS-e1682406176542.png")!),
       ...
       Video(imageName: "beginner-tableView",
             ...
             imageURL: URL(string: "https://developer.apple.com/xcode/images/xcode-15-hero-large_2x.jpg")!),
       ...
       Video(imageName: "delegates-protocols",
             ...
             imageURL: URL(string: "https://developer.apple.com/xcode/swiftui/images/example-design-large_2x.png")!),
       ...
       Video(imageName: "first-job",
             ...
             imageURL: URL(string: "https://www.oneclickitsolution.com/blog/wp-content/uploads/2022/09/BarMark-view-is-using-x-and-y-values.png")!),
       ...
       Video(imageName: "37-tips",
             ...
             imageURL: URL(string: "https://swift.org/assets/images/getting-started-guides/swiftui-ios/swiftui-circle-color.png")!),
       ...
       Video(imageName: "average-dev",
             ...
             imageURL: URL(string: "https://www.appcoda.com/learnswiftui/images/basic/swiftui-basic-2.gif")!),
